...
Source0  : https://mirrors.kernel.org/debian/pool/main/d/datefudge/datefudge_1.26.tar.xz
...
%prep
%setup -q -n datefudge-1.26
cd %{_builddir}/datefudge-1.26
%patch -P 1 -p1
pushd ..
cp -a datefudge-1.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719957795
...
cp %{_builddir}/datefudge-%{version}/COPYING %{buildroot}/usr/share/package-licenses/datefudge/dfac199a7539a404407098a2541b9482279f690d || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/datefudge/datefudge.so
