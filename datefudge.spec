...
Source0  : https://mirrors.kernel.org/debian/pool/main/d/datefudge/datefudge_1.24.tar.xz
...
%prep
%setup -q -n datefudge-1.24
cd %{_builddir}/datefudge-1.24
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594867434
...
cp %{_builddir}/datefudge-1.24/COPYING %{buildroot}/usr/share/package-licenses/datefudge/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/datefudge-1.24/debian/copyright %{buildroot}/usr/share/package-licenses/datefudge/462bb477ef46df38abade60d3044466969fbf068
%make_install
